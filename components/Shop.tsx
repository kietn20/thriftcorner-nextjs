			...
			<div className="flex flex-wrap justify-around gap-0">
				{allProducts?.map((product: any) => (
					<Link
						...
						target="_blank"
						key={product.title}
						className="group relative w-1/3 p-12 flex flex-col items-center justify-center bg-[#D9D9D9] bg-black border border-white hover:bg-[#7e9c6c] hover:ease-out duration-300"
					>
